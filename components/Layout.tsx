...
export const Layout: React.FC<LayoutProps> = ({
  ...
  return (
    <div className="min-h-screen flex flex-col selection:bg-indigo-100 selection:text-indigo-900">
            ...
            <nav className="hidden md:flex bg-slate-100/50 p-1 rounded-xl border border-slate-200/40">
              {navItems.map((item) => (
                <button
                  ...
                  className={`flex items-center space-x-2 px-4 py-2 rounded-lg text-sm font-bold transition-all duration-300 ${currentView === item.id
      ...
      {/* Footer with SaveIndicator */}
      <footer className="bg-slate-950 text-slate-500 py-6 px-6">
